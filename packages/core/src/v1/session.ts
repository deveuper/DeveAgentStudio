...
export const User = Schema.Struct({
  ...
  // True when the model was selected by role-profile routing for THIS message
  // only. Such a message must not become the session's default model.
  roleRouted: Schema.optional(Schema.Boolean),
