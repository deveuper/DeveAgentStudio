...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const cleanup = Effect.fn("Truncate.cleanup")(function* () {
      // Upstream fix (d46820195): purge by real file mtime instead of the
      // ULID-encoded timestamp embedded in the filename, so stale outputs from
      // interrupted runs are still cleaned up.
