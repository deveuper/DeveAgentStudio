...
namespace TestLLMServer {
  export interface Service {
    ...
    readonly errorMatch: (match: Match, status: number, body: unknown) => Effect.Effect<void>
  ...
  static readonly layer = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      return TestLLMServer.of({
        ...
        errorMatch: Effect.fn("TestLLMServer.errorMatch")(function* (match: Match, status: number, body: unknown) {
