...
describe("workspace CRUD", () => {
  ...
  it.instance(
    ...
    // Fresh layer provision for the false-flag path can exceed Bun's 5s
    // default on slow machines (same pattern as the pre-existing sibling
    // startWorkspaceSyncingWithFlag tests).
    { git: true },
    30_000,
  )
