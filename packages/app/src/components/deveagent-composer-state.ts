...
export type DeveAgentWorkPack = {
  ...
  name: string
  description: string
  // English description for non-Chinese locales; falls back to `description`.
...
export const DEVEAGENT_BUILTIN_SKILLS: DeveAgentSkillRef[] = [
  {
    ...
    descEn: "Real v1 context compaction: files over 1500 tokens keep the first 200 lines + last 80 lines, with the middle replaced by stable markers.",
    prosEn: "Genuinely reduces tokens; stable markers favor KV cache reuse; transparent and measurable.",
    consEn: "May drop key context in very long mid-file code; must be explicitly enabled.",
    whenToUseEn: "On by default. Keep it on for huge files, multi-file packs and Goal loops.",
  },
  {
    id: "headroom",
    name: "Headroom",
    ...
    descEn: "Reserves context budget before long edits to prevent context window overflow.",
    prosEn: "Avoids the model running out of context at the final step; noticeably stabilizes long Craft/Build tasks.",
    consEn: "Actively trims older conversation; wasteful for short tasks.",
    whenToUseEn: "Only for very long sessions (>50 rounds) or long Compose/Build tasks.",
  },
  {
    id: "context-mode",
    name: "Context Mode",
    ...
    descEn: "Chooses compact/balanced/expanded context pack strategies.",
    prosEn: "Adjusts context size to the task; simple tasks run faster and cheaper on compact.",
    consEn: "Requires manual tier selection; can conflict with Token Saver.",
    whenToUseEn: "When you want manual control over context granularity without automatic compaction.",
  },
  {
    ...
    descEn: "Summarizes tool output (bash, read, grep) keeping only actionable regions.",
    prosEn: "Very effective for shell/grep/log output; prevents noise from crowding out context.",
    consEn: "Hides the raw output; users need to understand the summarization boundary.",
    whenToUseEn: "Enable when running many shell/grep/log tools with output in the thousands of lines.",
  },
  {
    id: "rtk-caveman",
    name: "RTK Caveman",
    ...
    descEn: "Prefers simple, robust implementation paths; suppresses over-abstraction.",
    prosEn: "Works well for MVPs, prototypes and bug fixes; output is more focused.",
    consEn: "Can look naive on complex architecture tasks; not suited for refactors.",
    whenToUseEn: "Enable for small fixes, prototype demos and teaching examples; turn off for refactors or large projects.",
  },
  {
    ...
    descEn: "Packs task-relevant files + diff + symbol context before handing to the model.",
    prosEn: "The model sees only what matters for the task; less token waste.",
    consEn: "Index freshness depends on the last build; new files may lag.",
    whenToUseEn: "Enable for tasks in well-indexed repos where the relevant files are known.",
  },
  {
    id: "code-review",
    name: "Code Review",
    ...
    descEn: "Reviews diffs for regressions, dangerous writes and missing tests.",
    prosEn: "Catches common failure modes before they land; structured checklist.",
    consEn: "Adds latency per diff; can flag stylistic issues.",
    whenToUseEn: "Enable whenever a diff is about to be committed or merged.",
  },
  {
    id: "goal-verifier",
    name: "Goal Verifier",
    ...
    descEn: "Automatically verifies success criteria in Goal mode to avoid premature stops.",
    prosEn: "Prevents the agent from declaring victory early; per-criterion verdicts.",
    consEn: "Adds an extra model call per verification.",
    whenToUseEn: "Enable for long unattended Goal runs where premature completion is costly.",
  },
  {
    id: "computer-use",
    name: "Computer Use",
    ...
    descEn: "Permission-gated screenshots, browser and restricted desktop actions; raw shell execution is disabled.",
    prosEn: "Can see and operate real apps; every action is permission-checked and audited.",
    consEn: "Keyboard injection may be blocked by UIPI on elevated targets; platform-dependent.",
    whenToUseEn: "Enable for tasks that need to see or operate native apps beyond the workspace.",
  },
  {
    id: "superpowers",
    name: "Superpowers",
    ...
    descEn: "Loads debugging/review/planning/TDD skill packs and injects them into the system prompt.",
    prosEn: "Structured methodologies on demand; no separate engine needed.",
    consEn: "Longer system prompt; may not fit every task.",
    whenToUseEn: "Enable for tasks that benefit from a structured methodology.",
  },
  {
    id: "grill-me",
    name: "Grilling Me",
    ...
    descEn: "Interrogates unresolved decisions one question at a time before implementation, with recommended answers.",
    prosEn: "Surfaces hidden assumptions; produces a decision record.",
    consEn: "Adds rounds before real work starts.",
    whenToUseEn: "Enable for ambiguous specs where wrong assumptions are expensive.",
  },
  {
    id: "prompt-optimizer",
    ...
    descEn: "Organizes goals, constraints and acceptance criteria before execution while preserving the user's intent.",
    prosEn: "Cleaner inputs lead to better outputs; no original meaning lost.",
    consEn: "Adds a preprocessing step.",
    whenToUseEn: "Enable for complex or vague prompts.",
  },
  {
    id: "markitdown",
    name: "MarkItDown",
    ...
    descEn: "Converts supported attachments to cached Markdown before they enter context, reducing the cost of reading binary documents.",
    prosEn: "Cheap context for documents; cached for reuse.",
    consEn: "Conversion may fail on exotic formats; falls back to reading the original.",
    whenToUseEn: "On by default for document-heavy workflows.",
  },
]
...
export const DEVEAGENT_WORK_PACKS: DeveAgentWorkPack[] = [
  {
    ...
    descriptionEn: "Code graph, review, testing workflows and long-context control.",
    mode: "build",
    role: "coder",
  ...
  },
  {
    ...
    descriptionEn: "Frontend implementation, visual acceptance and browser interaction.",
    mode: "build",
    role: "coder",
  ...
  },
  {
    ...
    descriptionEn: "Multi-file engineering, test review and graphical acceptance basics.",
    mode: "build",
    role: "coder",
  ...
  },
  {
    ...
    descriptionEn: "Convert documents to Markdown first, then structured analysis and decision follow-ups.",
    mode: "craft",
    role: "planner",
  ...
  },
  {
    ...
    descriptionEn: "Long-text context, requirement probing and document intake basics.",
    mode: "craft",
    role: "planner",
  ...
  },
  {
    ...
    descriptionEn: "Parallel read-only planning, browser ops, log trimming and code review.",
    mode: "plan",
  ...
  },
  {
    ...
    descriptionEn: "Convert documents/tables to Markdown, then structured analysis and conclusion follow-ups.",
    mode: "craft",
    role: "planner",
  ...
  },
  {
    ...
    descriptionEn: "Code-graph impact, review workflow, read-only planning and vulnerability verification.",
    mode: "plan",
    toolExecution: "parallel",
    role: "reviewer",
  ...
  },
  {
    ...
    descriptionEn: "Log/document handling, browser ops and automation troubleshooting workflows.",
    mode: "build",
    role: "coder",
  ...
  },
  {
    ...
    descriptionEn: "Multi-agent orchestration, Goal/verification loops and long-task context control.",
    mode: "goal",
    role: "planner",
