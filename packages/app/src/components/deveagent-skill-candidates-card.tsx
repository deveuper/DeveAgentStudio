...
export function DeveagentSkillCandidatesCard() {
  ...
  // Candidates are produced by completed turns, so this card needs no fast
  // cadence; the panel-open lifetime plus low-power stretching is enough.
    ...
    <>
      ...
      <div data-component="deveagent-skill-candidates" class="rounded-lg border border-v2-border-border-muted bg-v2-background-bg-layer-01 p-3">
        <div class="mb-2 flex items-center justify-between">
          ...
          <span class="text-[10px] tabular-nums text-v2-text-text-faint">{candidates()!.length}</span>
        </div>
