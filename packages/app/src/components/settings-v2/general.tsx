...
export const SettingsGeneralV2: Component = () => {
  ...
  // Global settings has no route dir. Use the server's active directory so
  // Auto Accept remains an actionable setting outside a session URL.
  const dir = createMemo(
    () => decode64(params.dir) || serverSync().data.path.directory || serverSync().data.path.home || "",
  )
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <SettingsRowV2
          title={language.t("settings.general.row.goalAutoConfirm.title")}
          description={language.t("settings.general.row.goalAutoConfirm.description")}
        >
          <div data-action="settings-goal-auto-confirm">
            <Switch checked={settings.general.goalAutoConfirm()} onChange={(value: boolean) => settings.general.setGoalAutoConfirm(value)} />
          </div>
        </SettingsRowV2>
        ...
        >
          <div data-action="settings-new-layout-designs">
            <Switch
              checked={settings.general.newLayoutDesigns()} disabled
              onChange={(checked) => {
  ...
  const AdvancedSection = () => (
    <div class="settings-v2-section">
      ...
      <SettingsListV2>
        ...
        <SettingsRowV2
          title={language.t("settings.general.row.lowPowerMode.title")}
          description={language.t("settings.general.row.lowPowerMode.description")}
        >
          <div data-action="settings-low-power">
            <Switch
              checked={settings.general.lowPowerMode()}
              onChange={(checked) => settings.general.setLowPowerMode(checked)}
            />
          </div>
        </SettingsRowV2>
      </SettingsListV2>
