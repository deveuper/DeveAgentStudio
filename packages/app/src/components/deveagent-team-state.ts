...
export const TEAM_ROLE_PRESETS: Record<DeveAgentTeamRole, { label: string; labelEn: string; labelKey: string; systemPrompt: string }> = {
  planner: {
    label: "Planner 计划者",
    labelEn: "Planner",
    labelKey: "deveagent.team.role.planner",
    systemPrompt:
  ...
  executor: {
    label: "Executor 执行者",
    labelEn: "Executor",
    labelKey: "deveagent.team.role.executor",
    systemPrompt:
  ...
  reviewer: {
    label: "Reviewer 审查者",
    labelEn: "Reviewer",
    labelKey: "deveagent.team.role.reviewer",
    systemPrompt:
  ...
  verifier: {
    label: "Verifier 验证者",
    labelEn: "Verifier",
    labelKey: "deveagent.team.role.verifier",
    systemPrompt:
  ...
  custom: {
    label: "Custom 自定义",
    labelEn: "Custom",
    labelKey: "deveagent.team.role.custom",
    systemPrompt: "",
  },
}
