...
import { isSuperPasteShortcut, pasteMode } from "./paste"
...
describe("pasteMode", () => {
  ...
  test("detects Super/Meta+V without stealing Ctrl+V", () => {
    expect(isSuperPasteShortcut({ key: "v", metaKey: true, ctrlKey: false, altKey: false, shiftKey: false })).toBe(true)
    expect(isSuperPasteShortcut({ key: "V", metaKey: true, ctrlKey: false, altKey: false, shiftKey: false })).toBe(true)
    expect(isSuperPasteShortcut({ key: "v", metaKey: false, ctrlKey: true, altKey: false, shiftKey: false })).toBe(false)
    expect(isSuperPasteShortcut({ key: "v", metaKey: true, ctrlKey: false, altKey: false, shiftKey: true })).toBe(false)
  })
})
