              ...
              <For each={props.atFlat.slice(0, 10)}>
                {(item) => {
                  ...
                  if (item.type === "agent") {
                    return (
                      <button
                        class="w-full flex items-center gap-x-2 rounded-md px-2 py-0.5 hover:bg-surface-raised-base-hover"
              ...
              <For each={props.slashFlat}>
                {(cmd) => (
                  <button
                    ...
                    classList={{
                      "w-full flex items-center justify-between gap-4 rounded-md px-2 py-1 hover:bg-surface-raised-base-hover": true,
