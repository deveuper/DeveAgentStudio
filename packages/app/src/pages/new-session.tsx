    ...
    <div class="relative size-full min-h-0 min-w-0 overflow-hidden flex flex-col">
      ...
      <Show when={isDesktop() && !store.metricsPanelOpen}>
        <button
          ...
          title={language.t("deveagent.newSession.openOverviewPanel")}
        ...
        <div class="fixed inset-x-0 bottom-6 top-10 z-50 flex" onClick={() => setStore("memoryPanelOpen", false)}>
          ...
          >
            <div class="flex shrink-0 items-center justify-between border-b border-border-weak-base bg-background-base px-4 py-3">
              <span class="text-[14px] font-medium">{language.t("deveagent.sidebar.memory")}</span>
              <button
                type="button"
      ...
      <Show when={store.reviewPanelOpen}>
        <div class="fixed inset-x-0 bottom-6 top-10 z-50 flex" onClick={() => setStore("reviewPanelOpen", false)}>
          ...
          >
            <div class="flex shrink-0 items-center justify-between border-b border-border-weak-base bg-background-base px-4 py-3">
              <span class="text-[14px] font-medium">{language.t("deveagent.sidebar.review")}</span>
              <button
                type="button"
                class="text-text-weak hover:text-text-base"
                aria-label={language.t("deveagent.session.closeReviewPanel")}
                title={language.t("deveagent.session.closeReviewPanel")}
            ...
            <div class="flex min-h-0 flex-1 flex-col items-center justify-center gap-2 bg-background-base px-6 text-center">
              <div class="text-13-medium text-text-strong">{language.t("deveagent.newSession.noChangesYet")}</div>
              <div class="text-12-regular text-text-weak">{language.t("deveagent.newSession.noChangesHint")}</div>
            </div>
          </div>
        </div>
      </Show>
