...
// Abandoned question drafts survive remounts, but a long session can leave
// many unanswered requests behind — bound the draft cache like the timeline
// cache so it cannot grow without limit.
const QUESTION_DRAFT_CACHE_LIMIT = 64
...
export const SessionQuestionDock: Component<{ request: QuestionRequest; onSubmit: () => void }> = (props) => {
  ...
  onCleanup(() => {
    ...
    while (cache.size > QUESTION_DRAFT_CACHE_LIMIT) cache.delete(cache.keys().next().value!)
  })
