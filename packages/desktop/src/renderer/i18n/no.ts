export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av DeveAgent",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av DeveAgent er lastet ned. Vil du installere den og starte på nytt?",
