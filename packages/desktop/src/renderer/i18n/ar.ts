export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من DeveAgent",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من DeveAgent، هل ترغب في تثبيته وإعادة تشغيله؟",
