export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji DeveAgent",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} DeveAgent. Czy chcesz ją zainstalować i uruchomić ponownie?",
