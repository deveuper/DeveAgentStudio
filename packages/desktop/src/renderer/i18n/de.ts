export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von DeveAgent",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von DeveAgent wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
