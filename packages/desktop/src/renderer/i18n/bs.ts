export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju DeveAgent-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} DeveAgent-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
