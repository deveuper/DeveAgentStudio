export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de DeveAgent",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de DeveAgent a été téléchargée. Voulez-vous l'installer et redémarrer ?",
