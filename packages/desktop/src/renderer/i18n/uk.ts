export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію DeveAgent",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} DeveAgent завантажено. Бажаєте встановити її та перезапустити?",
