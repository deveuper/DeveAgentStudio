export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de DeveAgent",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de DeveAgent. ¿Quieres instalarla y reiniciar?",
