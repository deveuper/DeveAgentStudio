export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af DeveAgent",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af DeveAgent er blevet downloadet. Vil du installere den og genstarte?",
