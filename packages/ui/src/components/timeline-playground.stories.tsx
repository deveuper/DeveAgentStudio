...
const CSS_CONTROLS: CSSControl[] = [
  ...
  // --- Markdown headings ---
  // Single-value sliders can't express the per-level hierarchy shipped in
  // markdown.css (h1 1.43em / h2 1.21em / h3 1.07em); initials mirror the h1
  // defaults so the preview starts at the production scale.
  {
