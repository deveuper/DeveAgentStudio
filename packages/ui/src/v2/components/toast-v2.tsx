...
function ToastV2Root(props: ToastV2RootComponentProps) {
  const [local, rest] = splitProps(props, ["class", "classList", "children", "variant"])
  return (
    <Kobalte
...
export type ToastV2Variant = "normal" | "error" | "warning" | "success" | "info"
...
export function showToastV2(options: ToastV2Options | string) {
  ...
  return toaster.show((props) => (
    <ToastV2 toastId={props.toastId} duration={opts.duration} persistent={opts.persistent} variant={opts.variant}>
