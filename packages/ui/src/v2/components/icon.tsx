...
const icons = {
  ...
  microphone: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 10.5C9.38071 10.5 10.5 9.38071 10.5 8V4.5C10.5 3.11929 9.38071 2 8 2C6.61929 2 5.5 3.11929 5.5 4.5V8C5.5 9.38071 6.61929 10.5 8 10.5Z" stroke="currentColor"/><path d="M3.5 7.5V8C3.5 10.4853 5.51472 12.5 8 12.5C10.4853 12.5 12.5 10.4853 12.5 8V7.5M8 12.5V14.5M5.5 14.5H10.5" stroke="currentColor" stroke-linecap="square"/>`,
  },
  "sidebar-right": {
    viewBox: "0 0 20 20",
