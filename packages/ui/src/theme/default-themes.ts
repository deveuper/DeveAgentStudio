...
import deveagentDarkThemeJson from "./themes/deveagent-dark.json"
import deveagentLightThemeJson from "./themes/deveagent-light.json"
import deveagentForestThemeJson from "./themes/deveagent-forest.json"
import deveagentRetroThemeJson from "./themes/deveagent-retro.json"
...
export const deveagentDarkTheme = deveagentDarkThemeJson as DesktopTheme
export const deveagentLightTheme = deveagentLightThemeJson as DesktopTheme
export const deveagentForestTheme = deveagentForestThemeJson as DesktopTheme
export const deveagentRetroTheme = deveagentRetroThemeJson as DesktopTheme
...
export const DEFAULT_THEMES: Record<string, DesktopTheme> = {
  "oc-2": oc2Theme,
  "deveagent-dark": deveagentDarkTheme,
  "deveagent-light": deveagentLightTheme,
  "deveagent-forest": deveagentForestTheme,
  "deveagent-retro": deveagentRetroTheme,
  amoled: amoledTheme,
  aura: auraTheme,
  ayu: ayuTheme,
