...
frame. The status bar always shows context usage, cache hits, tokens, cost and
rounds; nothing is hidden behind a menu.
...
- 535 app unit tests, 265 agent-runtime tests, 6 locale-parity gates — green.
